...
//js purely for comment section
//hard-coded data used to demostrate comments between sneaker enthusiasts
const data = {
    "currentUser": {
      "image": { 
      ...
      "username": "SoleSeekerSamz"
    },
    "comments": [
      {
        "id": 1,
        "content": "Wow, the 'Shadow Blaze' sounds absolutely wild! I can't wait to see if these rumors are true. The description makes it sound like the ultimate sneaker for making a statement",
        ...
        "user": {
          ...
          "username": "FaithfulSneakz"
        },
        "replies": []
      },
      {
        "id": 2,
        "content": "I'm loving the whole rebellious vibe it's giving off. And that combination of burnt orange and jet black? So edgy.",
        ...
        "replies": [
          {
            "id": 3,
            "content": "I'm skeptical about the whole 'underground creativity' thing, though. Sounds like a marketing gimmick to me.",
            "createdAt": "1 week ago",
            "score": 4,
            "replyingTo": "KickGameA",
            "user": {
              "image": { 
          ...
          {
            "id": 4,
            "content": "Yeah, I get what you mean. But even if it's just hype, I'm still curious to see what they come up with. It's always fun to speculate about new releases.",
            "createdAt": "2 days ago",
            "score": 2,
            "replyingTo": "SteveStepz",
            "user": {
              "image": { 
                "png": "./images/avatars/image-juliusomo.png",
                "webp": "./images/avatars/image-juliusomo.webp"
              },
              "username": "StreetwearTay"
            },
          },
          {
            parent: 2,
